        ...
        game.save(function (err) {
          if (err) {
            ...
            var tId = setInterval(function () {
              ...
              // that should set a time interval for X second, 
              // If in no one clicked, end the game, 
              // If someone clicked and there are unused click reset the time interval. 
              // If there is no chance left. End the game
              //
              //countdowns[gameId]--
